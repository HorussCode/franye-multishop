(function() {
    ...
    // NÚMERO ACTUALIZADO: +584120852715 (Formato internacional sin símbolos)
    ...
    function renderizarProductos(lista) {
        ...
        lista.forEach(p => {
            ...
            div.innerHTML = `
                ...
                <div class="tarjeta-body" style="padding:15px;">
                    <h3 style="margin:0; font-size:1rem;">${p.nombre}</h3>
                    <p style="color:var(--dorado-brillante); font-weight:bold; margin:5px 0;">$${p.precio}</p>
